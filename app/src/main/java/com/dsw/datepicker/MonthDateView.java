...
public class MonthDateView extends View {
    ...
    public MonthDateView(Context context, AttributeSet attrs) {
        ...
        mUnableDateColor = typedArray.getColor(R.styleable.CalendarView_UnableDateColor, Color.parseColor("#000000"));
        ...
        mPriceColor = typedArray.getColor(R.styleable.CalendarView_PriceColor, Color.parseColor("#FF9B12"));//事务颜色
        mSelectBGColor = typedArray.getColor(R.styleable.CalendarView_SelectBGColor, Color.parseColor("#F8647D"));
        mCurrentColor = typedArray.getColor(R.styleable.CalendarView_CurrentColor, Color.parseColor("#F8647D"));
        ...
        mPriceSize = (int) typedArray.getDimension(R.styleable.CalendarView_PriceSize, 16);
        typedArray.recycle();
...
//        NUM_ROWS = getMonthRowNumber();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int day = 0; day < mMonthDays; day++) {
            ...
            //TODO 判断是否是今天,如果是今天,则设置holiday就可以
            if (mCurrMonth == mSelMonth && mCurrDay == day + 1) {
                holiday = "今日";
            }
