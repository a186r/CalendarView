...
public class WeekDayView extends View {
	//上横线颜色
	private int mTopLineColor = Color.parseColor("#9b9b9b");
	//下横线颜色
	private int mBottomLineColor = Color.parseColor("#9b9b9b");
	//周一到周五的颜色
	private int mWeedayColor = Color.parseColor("#9b9b9b");
	//周六、周日的颜色
	private int mWeekendColor = Color.parseColor("#9b9b9b");
	//线的宽度
